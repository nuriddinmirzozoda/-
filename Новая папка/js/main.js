...
(function () {
  ...
  function goTo(n, byUser) {
    ...
    var activeCapSpan = reel.slides[reel.i].querySelector(".caption span");
    if (activeCapSpan) {
      activeCapSpan.style.animation = "none";
      void activeCapSpan.offsetWidth;
      activeCapSpan.style.animation = "";
    }
    $("captionLive").textContent = C.photos[reel.i].caption || "";
